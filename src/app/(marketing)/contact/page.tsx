...
export default function ContactPage() {
  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-16">
      <h1 className="font-display text-4xl font-bold tracking-tight text-midnight">Contact</h1>
      ...
      <div className="mt-12 grid gap-12 lg:grid-cols-[1fr_340px]">
        ...
        <aside className="space-y-6 rounded-lg border border-mist-200 bg-mist p-6">
          <div>
            ...
            <ul className="mt-3 space-y-3 text-sm text-gray-700">
              ...
              {contact.phone && (
                <li className="flex gap-3">
                  <Phone className="mt-0.5 h-4 w-4 shrink-0 text-forest" aria-hidden />
              ...
              <li className="flex gap-3">
                <Clock className="mt-0.5 h-4 w-4 shrink-0 text-forest" aria-hidden />
          ...
          <div className="border-t border-mist-200 pt-6">
            ...
            <p className="mt-3 text-sm text-gray-700">
              ...
              <a href="/portal" className="font-semibold text-forest hover:underline">
                portal
              </a>
