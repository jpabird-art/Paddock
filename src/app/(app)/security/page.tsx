      ...
      <div className="bg-white rounded-lg border shadow-sm p-6 space-y-4">
        ...
        {!mfaEnabled && !setupData && (
          <button
            onClick={handleSetup}
            disabled={loading}
            className="bg-[#0F3D2E] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#156046] transition-colors disabled:opacity-60"
          >
          ...
          <div className="space-y-5 pt-2">
            ...
            <form onSubmit={handleVerify} className="space-y-3">
              ...
              <input
                ...
                maxLength={6}
                required
                className="w-40 border border-gray-300 rounded-md px-3 py-2 text-sm font-mono tracking-widest text-center focus:outline-none focus:ring-2 focus:ring-[#0F3D2E] focus:border-transparent"
              />
              <div>
                <button
                  type="submit"
          ...
          <form onSubmit={handleDisable} className="space-y-3 pt-2 border-t">
            ...
            <div className="flex gap-2">
              <input
                ...
                required
                className="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#0F3D2E] focus:border-transparent"
              />
              <button
                type="submit"
