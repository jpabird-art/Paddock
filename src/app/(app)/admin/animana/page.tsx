  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div className="flex items-center gap-2 text-sm text-gray-500">
        <Link href="/admin" className="hover:text-brand-forest hover:underline">
          Administration
        </Link>
        <span>/</span>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base font-semibold flex items-center gap-2">
              <Upload className="h-4 w-4 text-brand-forest" />
              Upload PDF
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div
                className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${
                  file ? "border-brand-forest/30 bg-brand-forest/5" : "border-gray-200 hover:border-gray-300"
                }`}
              >
                {file ? (
                  <div className="space-y-2">
                    <FileText className="h-8 w-8 text-brand-forest mx-auto" />
                  ...
                  <label className="cursor-pointer space-y-2 block">
                    ...
                    <p className="text-sm text-gray-600">
                      Drop an Animana PDF here or <span className="text-brand-forest underline">browse</span>
                    </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3 pt-2">
                  <Link
                    href={`/horses/${importResult.horse.id}`}
                    className="text-sm text-brand-forest hover:underline font-medium"
                  >
                    View Horse Profile →
                  </Link>
                  <button
