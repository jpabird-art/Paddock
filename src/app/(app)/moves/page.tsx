    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        {canEdit && (
          <Link
            href="/moves/new"
            className="bg-[#0F3D2E] hover:bg-[#156046] text-white px-4 py-2 rounded-md text-sm font-medium transition-colors"
          >
            New Move
          </Link>
        )}
      ...
      <div className="flex flex-wrap gap-4 items-center">
        ...
        <form method="GET" action="/moves" className="flex gap-2 items-center">
          ...
          <input
            ...
            className="border border-gray-200 rounded-md px-3 py-1 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#0F3D2E]/30"
          />
        </form>
      </div>
