              ...
              <tbody className="divide-y">
                {allocations.map((alloc) => {
                  ...
                  return (
                    <tr
                      key={alloc.id}
                      className={isCurrent ? "bg-brand-forest/5" : ""}
                    >
                      <td className="px-4 py-3 text-gray-800">
                        {alloc.tackItem.type}
                        {isCurrent && (
                          <span className="ml-2 inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-brand-forest text-white">
                            Current
                          </span>
                        )}
                      </td>
