  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-3">
        <div className="bg-brand-forest text-white text-sm font-semibold px-3 py-1 rounded-md">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2">
        ...
        {canEdit && (
          <button
            ...
            className="border border-dashed border-gray-300 rounded-lg p-3 flex items-center justify-center gap-1.5 text-xs text-gray-400 hover:text-brand-forest hover:border-brand-forest transition-colors min-h-[80px]"
          >
