      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-2 mb-1">
          <Link
            ...
            className="text-sm font-semibold text-gray-900 hover:text-brand-forest hover:underline truncate"
          >
      ...
      {canEdit && (
        <div className="flex items-center gap-1 shrink-0">
          <button
            ...
            className="p-1 text-gray-400 hover:text-brand-forest rounded transition-colors"
            title="Edit"
          >
